      ...
      [
        ...
        function (t, e, n) {
          ...
          ((r.prototype = new i())._create = function () {
            ...
            (r.prototype.read_options = function (t) {
              var e = this._create();
              for (var n in _) e._disabled[n] = -1 === t.templating.indexOf(n);
              return e._update(), e;
            }),
        ...
        function (t, e, n) {
          ...
          (d.prototype.get_parser_token = function () {
            ...
            (f.prototype.beautify = function () {
              ...
              var n = (t = t.replace(c, "\n")).match(/^[\t ]*/)[0],
                i = { text: "", type: "" },
                _ = new g(),
                r = new p(this._options, n),
                s = new h(t, this._options).tokenize();
              this._tag_stack = new d(r);
              for (var a = null, o = s.next(); o.type !== u.EOF; )
                o.type === u.TAG_OPEN || o.type === u.COMMENT
                  ? (_ = a = this._handle_tag_open(r, o, _, i))
                  : o.type === u.ATTRIBUTE ||
                    o.type === u.EQUALS ||
                    o.type === u.VALUE ||
                    (o.type === u.TEXT && !_.tag_complete)
                  ? (a = this._handle_inside_tag(r, o, _, s))
                  : o.type === u.TAG_CLOSE
                  ? (a = this._handle_tag_close(r, o, _))
                  : o.type === u.TEXT
                  ? (a = this._handle_text(r, o, _))
                  : r.add_raw_token(o),
                  (i = a),
                  (o = s.next());
          ...
          (f.prototype._get_tag_open_token = function (t) {
            ...
            return (
              ...
              (e.is_end_tag =
                e.is_end_tag || a(e.tag_check, this._options.void_elements)),
              (e.is_empty_element =
                e.tag_complete || (e.is_start_tag && e.is_end_tag)),
              (e.is_unformatted =
                !e.tag_complete && a(e.tag_check, this._options.unformatted)),
              (e.is_content_unformatted =
                !e.is_empty_element &&
                a(e.tag_check, this._options.content_unformatted)),
              (e.is_inline_element =
                a(e.tag_name, this._options.inline) ||
                "{" === e.tag_start_char),
              e
            );
          }),
            (f.prototype._set_tag_position = function (t, e, n, i, _) {
              if (
                ...
                a(n.tag_check, this._options.extra_liners) &&
                  (t.print_newline(!1),
        ...
        function (t, e, n) {
          ...
          var r = n(9).Tokenizer,
            ...
            h = new s(/<\!--/, /-->/);
          ((i.prototype = new r())._is_comment = function (t) {
            return !1;
          }),
            (i.prototype._is_opening = function (t) {
              ...
              if (n && "<" === n.text[0])
                if ("=" === t)
                  ...
                  (r +=
                    ...
                    (i = this._create_token(p.VALUE, r));
                } else
                  (_ = this.__patterns.attribute.read()) &&
                    (i =
                      e.type === p.EQUALS
                        ? this._create_token(p.VALUE, _)
                        : this._create_token(p.ATTRIBUTE, _));
              return i;
            }),
            ...
            (i.prototype._read_raw_content = function (t, e, n) {
              ...
              else if (e.type === p.TAG_CLOSE && "<" === e.opened.text[0]) {
                var _ = e.opened.text.substr(1).toLowerCase();
                if ("script" === _ || "style" === _) {
                  var r = this._read_comment_or_cdata(t);
                  if (r) return (r.type = p.TEXT), r;
                  i = this._input.readUntil(
                    new RegExp("</" + _ + "[\\n\\r\\t ]*?>", "ig")
                  );
                } else
                  this._is_content_unformatted(_) &&
                    (i = this._input.readUntil(
                      new RegExp("</" + _ + "[\\n\\r\\t ]*?>", "ig")
                    ));
              }
    ...
    define(["require", "./beautify", "./beautify-css"], function (t) {
      ...
      return {
        html_beautify: function (t, e) {
          return r(t, e, n.js_beautify, i.css_beautify);
        },
      };
    });
  else if ("undefined" != typeof exports) {
    var s = require("./beautify.js"),
      a = require("./beautify-css.js");
    exports.html_beautify = function (t, e) {
      return r(t, e, s.js_beautify, a.css_beautify);
    };
  } else
    "undefined" != typeof window
      ? (window.html_beautify = function (t, e) {
          return r(t, e, window.js_beautify, window.css_beautify);
        })
      : "undefined" != typeof global &&
        (global.html_beautify = function (t, e) {
          return r(t, e, global.js_beautify, global.css_beautify);
        });
})();
